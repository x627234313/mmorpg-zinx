...
type SyncPid struct {
	...
	Pid int32 `protobuf:"varint,1,opt,name=Pid,proto3" json:"Pid,omitempty"` // 服务器生成的玩家ID
}
...
type Position struct {
	...
	Z float32 `protobuf:"fixed32,3,opt,name=Z,proto3" json:"Z,omitempty"` // 纵坐标
	V float32 `protobuf:"fixed32,4,opt,name=V,proto3" json:"V,omitempty"` // 角度
}
...
type BroadCast struct {
	...
	Tp  int32 `protobuf:"varint,2,opt,name=Tp,proto3" json:"Tp,omitempty"` // 1 世界聊天，2 玩家位置，3 动作，4 移动之后坐标
